"""
Logging Callbacks to save images and videos during training
"""
...
from synthraddiffusion.vqgan.utils import save_video_grid


class ImageLogger(Callback):
    """
    Class that logs images once per epoch
    """
