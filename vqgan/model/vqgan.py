...
from vqgan.utils import shift_dim, adopt_weight, comp_getattr
from vqgan.model.lpips import LPIPS
from vqgan.model.codebook import Codebook
...
class VQGAN(pl.LightningModule):
  def __init__(self, cfg):
    ...
    self.image_discriminator = NLayerDiscriminator(cfg.dataset.image_channels, cfg.model.disc_channels, cfg.model.disc_layers, norm_layer=nn.BatchNorm2d)
    self.video_discriminator = NLayerDiscriminator3D(cfg.dataset.image_channels, cfg.model.disc_channels, cfg.model.disc_layers, norm_layer=nn.BatchNorm3d)
